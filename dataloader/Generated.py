...
class Generated_Dataset(torch.utils.data.Dataset):
    def __init__(self, root, train, test_size=0.1, transform=None):
        ...
        labels_file = os.path.join(root, "label.txt")
...
if __name__ == '__main__':
    root_dir = 'data/generated_can_data'
    batch_size = 10
    ...
    train_dataset = Generated_Dataset(root=root_dir, train=True, test_size=0.1, transform=composed_transform)
    test_dataset = Generated_Dataset(root=root_dir, train=False, test_size=0.1, transform=composed_transform)
